...
export default function NavBar(): React.JSX.Element {
  ...
  return (
    <nav className="bg-white flex gap-2 relative items-center p-2">
      {/* title and logo */}
      <Link href="/" className='font-bold text-accent-dark flex flex-row items-center gap-2'>
      ...
      <div className="gap-8 flex flex-row">
        ...
        >
          ...
          >
          {showTakeAction && (
            <div className="bg-pale-grey shadow-md mt-2 p-2 flex flex-col w-48">
        ...
        >
          ...
          { showAbout ? <ExpandLessIcon /> : <ExpandMoreIcon />}
